...
## Hardware
Tested with SIM800 (GSM) and Feasycom FSC-BT836B (Bluetooth and Bluetooth BLE).
...
NOTE:
- parameter positions are identified by 0,1,2,3, ... etc. with 0 being the first parameter.
